export const qaData = [
    {
      ...
      descp: `Our templates have been crafted by Certified Career
    Experts. Choose a resume template here.`,
    },
    {
      Icon: () => {
        return (
    ...
    },
    {
      ...
      title: "Resume Check",
      descp: `The Permresume Resume Builder instantly evaluates and rates your resume. Review your resume's performance here.`,
    },
    {
      Icon: () => {
        return (
      ...
      descp: `
      Create a cover letter using a template that complements your resume. Customize your cover letter here.`,
    },
    {
      Icon: () => {
        return (
      ...
      title: "Fast and Easy to Use Generator",
      descp: `
      Easily incorporate pre-designed content customized for your resume by dragging and dropping with a simple click, all within a flexible text editor.`,
    },
    {
      Icon: () => {
        return (
